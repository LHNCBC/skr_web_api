 ...
 * You will be prompted for your UTS API key and if they are alright,
 ...
 * 
 * This program reads the environment variable EMAIL to set the user's
 * email address and UTS_API_KEY to set the user's UTS API Key.
 *
 * @author	Jim Mork
...
public class GenericBatchEnv
{
   public static void main(String args[])
   {
        GenericObject myGenericObj = new GenericObject();

        // NOTE: You MUST specify an email address because it is used
        //       for logging purposes.  Set the environment variable
        //       EMAIL to your email address.

  	if (System.getenv("EMAIL") == null) {
	  System.err.println("please set the environment variable EMAIL before running this program.");
	  System.exit(1);
	}
	myGenericObj.setField("Email_Address", System.getenv("EMAIL"));
