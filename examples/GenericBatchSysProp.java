...
public class GenericBatchSysProp
{
   public static void main(String args[])
   {
        ...
        myGenericObj.setField("Email_Address", System.getProperty("generic.batch.email","youraddress@goeshere"));
        myGenericObj.setFileField("UpLoad_File", System.getProperty("generic.batch.uploadfile","./sample.txt"));
        myGenericObj.setField("Batch_Command", System.getProperty("generic.batch.command","MTI -opt1L_DCMS -E"));
        myGenericObj.setField("BatchNotes", System.getProperty("generic.batch.notes","SKR API test"));
        myGenericObj.setField("SilentEmail", Boolean.parseBoolean(System.getProperty("generic.batch.silent_email","true")));
